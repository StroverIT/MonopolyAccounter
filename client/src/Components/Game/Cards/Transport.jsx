...
export default function TransportCard({ card, boughtData }) {
  return (
    <div className="bg-gray-100 ">
      ...
      <div className="px-4 pb-5">
        <div className="flex justify-between">
          <h3>Ако притежавате 2 транспортни компании</h3>
          <div className="font-semibold">{format(card.twoTransport)}</div>
        </div>
        <div className="flex justify-between">
          <h3>Ако притежавате 3 транспортни компании</h3>
          <div className="font-semibold">{format(card.threeTransport)}</div>
        </div>
        <div className="flex justify-between">
          <h3>Ако притежавате 4 транспортни компании</h3>
          <div className="font-semibold">{format(card.fourTransport)}</div>
        </div>
